...
class LengthValidator:
    ...
    def __call__(self, str_len):
        if self.min_len <= len(str_len) <= self.max_len:
            return True
        raise ValueError(f"Длина строки должна быть в диапазоне от {self.min_len} до {self.max_len}")
...
result1 = HasText("Success")("Test passed: Success") # True
print(result1)

result2 = HasText("Error")("All OK") # False
print(result2)
